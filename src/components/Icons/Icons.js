export const HomeIcon = ({ width = '3.2rem', height = '3.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const PopularIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const NewsIcon = ({ width = '3.2rem', height = '3.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const SearchIcon = ({ width = '2.4rem', height = '2.4rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const ClearSearchIcon = ({ width = '1.6rem', height = '1.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const MessageIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const ImageIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const PlusIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const ContentIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const PollIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const BoldIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const ItalicIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const UnderlineIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const NotifyIcon = ({ width = '2.4rem', height = '2.4rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const BarsIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
    ...
    >
        <path
            d="M18.25 4.7H1.75A.772.772 0 0 1 1 3.95c0-.399.352-.75.75-.75h16.5c.398 0 .75.351.75.75 0 .397-.352.75-.75.75ZM19 9.996a.772.772 0 0 0-.75-.75H1.75a.772.772 0 0 0-.75.75c0 .398.352.75.75.75h16.5c.398 0 .75-.352.75-.75Zm0 6.047a.772.772 0 0 0-.75-.75H1.75a.772.772 0 0 0-.75.75c0 .398.352.75.75.75h16.5c.398 0 .75-.352.75-.75Z"
        ></path>
    </svg>
);

export const UploadIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const LanguagesIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const AdvertiseIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const HelpIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const SettingIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const UserIcon = ({ width = '2.4rem', height = '3.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const LogoutIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const DownIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const SendIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    ...
    >
        <path
            d="M2.18 9.67A2 2 0 0 1 4 8.5h40a2 2 0 0 1 1.74 3l-20 35a2 2 0 0 1-3.65-.4l-5.87-18.6L2.49 11.82a2 2 0 0 1-.31-2.15Zm18.2 17.72 4.15 13.15L40.55 12.5H8.41l9.98 11.41 11.71-7.2a1 1 0 0 1 1.38.32l1.04 1.7a1 1 0 0 1-.32 1.38L20.38 27.4Z"
        ></path>
    </svg>
);

export const ShareIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const LikeIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const LikeActiveIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const CommentIcon = ({ width = '2.2rem', height = '2.2rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const HiddenIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const MoreIcon = ({ width = '2.4rem', height = '2.4rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const SaveIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const EditIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const ReportIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const TrashIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const BackIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
    ...
    >
        <path
            d="M18 9.25H3.81l6.22-6.22a.771.771 0 0 0-.015-1.046.772.772 0 0 0-1.045-.014l-7.5 7.5a.75.75 0 0 0 0 1.06l7.5 7.5c.283.27.77.263 1.046-.013a.772.772 0 0 0 .014-1.047l-6.22-6.22H18c.398 0 .75-.352.75-.75a.772.772 0 0 0-.75-.75Z"
        ></path>
    </svg>
);

export const LeftIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const RightIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const FilterIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const GrowIcon = ({ width = '2.6rem', height = '2.6rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const CameraIcon = ({ width = '2.4rem', height = '2.4rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
// Icon Admin
export const DashboardIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const UserManagementIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const PostManagementIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
    ...
    >
        <path
            d="M19.375 2h-7.292A2.688 2.688 0 0 0 10 3a2.688 2.688 0 0 0-2.083-1H.625A.625.625 0 0 0 0 2.625v14.75A.625.625 0 0 0 .625 18h7.917v-1.25H1.25V2.85h6.667a1.465 1.465 0 0 1 1.458 1.469v11.093h1.25V4.719a1.465 1.465 0 0 1 1.458-1.469h6.667v13.5h-6.667a2.64 2.64 0 0 0-2.708 2.625V20h1.25v-.625A1.388 1.388 0 0 1 12.083 18h7.292a.624.624 0 0 0 .625-.625V2.625A.625.625 0 0 0 19.375 2Z"
        ></path>
    </svg>
);

export const StatisticIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const ReportAdminIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const UserAdminIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const PostAdminIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
...
export const InteractAdminIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M9.96541 22.75H7.79541C7.40541 22.75 6.62542 22.6299 6.17542 22.1899L4.47541 20.88L5.39541 19.6899L7.16541 21.06C7.29541 21.17 7.56541 21.25 7.79541 21.25H9.96541C10.3354 21.25 10.7554 20.94 10.8354 20.62L12.2254 16.39C12.2654 16.29 12.2954 16.14 12.2254 16.03C12.1654 15.94 12.0254 15.89 11.8554 15.89H9.56541C9.17541 15.89 8.81541 15.72 8.55541 15.43C8.29541 15.13 8.18541 14.7499 8.24541 14.3399L8.53541 12.5C8.57541 12.33 8.45541 12.1199 8.29541 12.0699C8.16541 12.0199 7.94541 12.11 7.89541 12.18L5.54541 15.67L4.29541 14.8299L6.63541 11.3399C7.07541 10.6799 8.03541 10.38 8.77541 10.66C9.62541 10.94 10.1854 11.9 9.98541 12.78L9.73541 14.38H11.8254C12.4954 14.38 13.0754 14.66 13.4254 15.16C13.7654 15.64 13.8354 16.27 13.6154 16.87L12.2454 21.03C12.0454 21.97 11.0254 22.75 9.96541 22.75Z" fill="#1877f2" />
        <path d="M3.73539 22.12H3.16539C1.60539 22.12 1.27539 21.12 1.27539 20.28V14.6801C1.27539 13.8401 1.60539 12.84 3.16539 12.84H3.73539C5.29539 12.84 5.62539 13.8401 5.62539 14.6801V20.28C5.62539 21.12 5.29539 22.12 3.73539 22.12ZM2.80539 20.58C2.81539 20.58 2.91539 20.62 3.15539 20.62H3.72539C3.98539 20.62 4.07539 20.5799 4.09539 20.5699C4.09539 20.5599 4.12539 20.49 4.12539 20.28V14.6801C4.12539 14.4701 4.09539 14.39 4.08539 14.38C4.08539 14.4 3.98539 14.34 3.73539 14.34H3.16539C2.90539 14.34 2.81539 14.38 2.79539 14.39C2.79539 14.4 2.76539 14.4701 2.76539 14.6801V20.28C2.76539 20.49 2.79539 20.57 2.80539 20.58Z" fill="#1877f2" />
        <path d="M15.8258 13.4399C15.6258 13.4399 15.4258 13.41 15.2358 13.34C14.3858 13.06 13.8258 12.1 14.0258 11.22L14.2758 9.62H12.1858C11.5158 9.62 10.9358 9.33997 10.5858 8.83997C10.2458 8.35997 10.1758 7.73 10.3958 7.13L11.7658 2.96997C11.9958 2.02997 13.0258 1.25 14.0758 1.25H16.2458C16.6358 1.25 17.4158 1.37006 17.8658 1.81006L19.5658 3.12L18.6458 4.31006L16.8758 2.93994C16.7458 2.82994 16.4758 2.75 16.2458 2.75H14.0758C13.7058 2.75 13.2858 3.06 13.2058 3.38L11.8158 7.60999C11.7758 7.70999 11.7458 7.85997 11.8158 7.96997C11.8758 8.05997 12.0158 8.10999 12.1858 8.10999H14.4758C14.8658 8.10999 15.2258 8.27995 15.4858 8.56995C15.7458 8.86995 15.8558 9.25003 15.7958 9.66003L15.5058 11.5C15.4658 11.67 15.5858 11.8801 15.7458 11.9301C15.8858 11.9801 16.0958 11.8999 16.1458 11.8199L18.4958 8.32996L19.7458 9.17004L17.4058 12.66C17.0458 13.14 16.4258 13.4399 15.8258 13.4399Z" fill="#1877f2" />
        <path d="M20.8755 11.16H20.3055C18.7455 11.16 18.4155 10.1599 18.4155 9.31995V3.71997C18.4155 2.87997 18.7455 1.88 20.3055 1.88H20.8755C22.4355 1.88 22.7655 2.87997 22.7655 3.71997V9.31995C22.7655 10.1599 22.4355 11.16 20.8755 11.16ZM19.9455 9.62C19.9555 9.62 20.0555 9.66003 20.2955 9.66003H20.8655C21.1255 9.66003 21.2155 9.61999 21.2355 9.60999C21.2355 9.59999 21.2655 9.52995 21.2655 9.31995V3.71997C21.2655 3.50997 21.2355 3.44004 21.2255 3.42004C21.2355 3.46004 21.1255 3.38 20.8755 3.38H20.3055C20.0455 3.38 19.9555 3.42005 19.9355 3.43005C19.9355 3.44005 19.9055 3.50997 19.9055 3.71997V9.31995C19.9055 9.52995 19.9355 9.6 19.9455 9.62Z" fill="#1877f2" />
    </svg>
);
export const SalesAdminIcon = ({ width = '2.8rem', height = '2.8rem', onClick, className }) => (
    <svg
        onClick={onClick}
        className={className}
        width={width}
